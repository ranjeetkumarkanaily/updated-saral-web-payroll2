class SalaryGroupDetail < ActiveRecord::Base
  attr_accessible :id,:calc_type, :calculation,:based_on,:salary_group_id,:salary_head_id,:pf_applicability,:pf_percentage,:print_name,:print_order, :created_at,:updated_at
  acts_as_audited
