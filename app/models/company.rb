class Company < ActiveRecord::Base
  attr_accessible :companyname, :responsible_person, :address, :website, :dateofestablishment, :phonenumber1, :phonenumber2 , :address2, :address3, :email, :pt, :tds, :photo_file_name, :photo_content_type, :photo_file_size, :created_at,:updated_at
  acts_as_audited
