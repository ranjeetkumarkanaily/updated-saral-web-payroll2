...
describe EsiGroupsController do
  ...
  # EsiGroup. As you add validations to EsiGroup, be sure to
  ...
  # EsiGroupsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested esi_group as @esi_group" do
      esi_group = EsiGroup.create! valid_attributes
      get :show, {:id => esi_group.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested esi_group as @esi_group" do
      esi_group = EsiGroup.create! valid_attributes
      get :edit, {:id => esi_group.to_param}, valid_session
      assigns(:esi_group).should eq(esi_group)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new EsiGroup" do
        expect {
          post :create, {:esi_group => valid_attributes}, valid_session
      ...
      it "redirects to the created esi_group" do
        post :create, {:esi_group => valid_attributes}, valid_session
        response.should redirect_to(EsiGroup.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved esi_group as @esi_group" do
        ...
        post :create, {:esi_group => {}}, valid_session
        assigns(:esi_group).should be_a_new(EsiGroup)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested esi_group" do
        esi_group = EsiGroup.create! valid_attributes
        # Assuming there are no other esi_groups in the database, this
        # specifies that the EsiGroup created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        EsiGroup.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => esi_group.to_param, :esi_group => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested esi_group as @esi_group" do
        esi_group = EsiGroup.create! valid_attributes
        put :update, {:id => esi_group.to_param, :esi_group => valid_attributes}, valid_session
        assigns(:esi_group).should eq(esi_group)
      end
      ...
      it "redirects to the esi_group" do
        esi_group = EsiGroup.create! valid_attributes
        put :update, {:id => esi_group.to_param, :esi_group => valid_attributes}, valid_session
        response.should redirect_to(esi_group)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the esi_group as @esi_group" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        EsiGroup.any_instance.stub(:save).and_return(false)
        put :update, {:id => esi_group.to_param, :esi_group => {}}, valid_session
        assigns(:esi_group).should eq(esi_group)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested esi_group" do
      esi_group = EsiGroup.create! valid_attributes
      expect {
        delete :destroy, {:id => esi_group.to_param}, valid_session
      }.to change(EsiGroup, :count).by(-1)
    end
