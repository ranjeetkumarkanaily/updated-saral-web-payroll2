Given /^Salary rate for employee Shivarudraiah defined$/ do
  ...
  SalaryAllotment.create(employee_id: employee.id, employee_detail_id: emp_detail.id, effective_date: "2012-01-01", salary_head_id: sal_head.id, salary_allotment: 0, salary_group_detail_id: sal_grp_detail.id)
end
