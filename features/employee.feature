...
#    Then User should see the text "Employee statutory was successfully updated."
  ...
  Scenario: Employees excel upload
    ...
    Then User should redirect to employees index page

  Scenario: Employees excel sample file
    When User follow "Employees" link
    And User follow "Generate Sample Template" link
    When User go to the sample template page
    Then User should redirect to generate_sample_excel_template
